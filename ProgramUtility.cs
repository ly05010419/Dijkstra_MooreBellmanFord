        ...
        public static Graph getGraphByFile(string path, bool directed)
        {
            ...
            while ((lineStr = sr.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    if (!directed)
                    {
                        createNode(int.Parse(word[1]), int.Parse(word[0]), float.Parse(word[2]), nodeList);
                        createEdge(int.Parse(word[1]), int.Parse(word[0]), float.Parse(word[2]), nodeList, edgeList);
                    }
                }
